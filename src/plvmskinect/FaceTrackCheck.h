...
namespace plvmskinect
{
    ...
    private:
		...
		mutable QMutex m_submitFaceTracking;
		mutable QMutex m_setCenterMutex;
...
*/
		void finished();
		//void faceRotationUpdate(float xpos);
		//void faceRotationUpdate(FLOAT *rotationarray);
		void faceRotationUpdate(float x,float y, float z);
		void faceTranslationUpdate(float x,float y, float z);
