#ifndef PLVADVANCEDTRACKERPLUGIN_H
#define PLVADVANCEDTRACKERPLUGIN_H
...
class PlvAdvancedTrackingProcessor : public plv::PipelineProcessor
{
    Q_OBJECT
    Q_DISABLE_COPY( PlvAdvancedTrackingProcessor )
...
public:
    PlvAdvancedTrackingProcessor();
    virtual ~PlvAdvancedTrackingProcessor();
...
#endif // PlvAdvancedTrackingProcessor_H //PLVSYNCHRONYPROCESSOR_H
