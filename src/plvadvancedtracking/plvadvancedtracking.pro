...
TEMPLATE = lib
TARGET = plv_advancedtracking_plugin
CONFIG += plugin
QT += core
QT -= gui
...
DEFINES += PLVADVANCEDTRACKINGPLUGIN_LIBRARY

SOURCES += plvadvancedtrackingplugin.cpp \
		   plvadvancedtrackingprocessor.cpp \
		   PlvAdvancedTrackingSum.cpp

HEADERS +=  plvadvancedtrackingplugin.h \
			plv_advancedtracking_plugin_global.h \
		   plvadvancedtrackingprocessor.h \
		   PlvAdvancedTrackingSum.h
