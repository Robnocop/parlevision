...
//constructor
PlvAdvancedTrackingProcessor::PlvAdvancedTrackingProcessor() :
...
bool PlvAdvancedTrackingProcessor::init()
{
    return true;
}

bool PlvAdvancedTrackingProcessor::deinit() throw ()
{
    return true;
}

bool PlvAdvancedTrackingProcessor::start()
{
    return true;
}

bool PlvAdvancedTrackingProcessor::stop()
{
    return true;
}

bool PlvAdvancedTrackingProcessor::process()
{
...
double PlvAdvancedTrackingProcessor::corr(long fIndex, long gIndex)
{
