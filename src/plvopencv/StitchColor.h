...
#ifndef STITCHCOLOR_H
#define STITCHCOLOR_H
...
//namespace plv
{
    ...
    class StitchColor : public plv::PipelineProcessor
    {
        Q_OBJECT
        Q_CLASSINFO("author", "Robby van Delden, copy of Richard Loos' stitch ")
        Q_CLASSINFO("name", "StitchColor")
        Q_CLASSINFO("description", "Stitches multiple color images")
